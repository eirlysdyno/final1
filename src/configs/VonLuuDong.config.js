import vld from "../assets/images/sanxuat-1.png"
...
export const VonLuuDong = {
  header: {
    title: "Khách hàng dễ dàng vay kinh doanh bổ sung vốn ngắn hạn",
    subtitle: "Giúp khách hàng bổ sung dòng tiền thiếu hụt ngắn hạn để đầu tư vào kinh doanh",
    image: vld,
    breadcrumb: [
    ...
    { label: "Vay kinh doanh bổ sung vốn lưu động"},
  ]
  },
  ...
  sections: [
    {
      ...
      items: [
        ...
        { img: why2, title: "Thời hạn vay linh hoạt; Hạn mức vay lớn" }
      ],
    },
    ...
    {
      type: "form-cards",
      title: "HƯỚNG DẪN ĐĂNG KÝ - VAY KINH DOANH BỔ SUNG VỐN LƯU ĐỘNG",
      image: tk,
      accordion: [
        {
